      ...
      >
        {gradient && (
          <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            <motion.div
              ...
              className="absolute inset-auto right-1/2 h-56 overflow-visible w-fl-2xl bg-gradient-conic from-primary/60 via-transparent to-transparent [--conic-position:from_70deg_at_center_top]"
            >
            ...
            <motion.div
              ...
              className="absolute inset-auto left-1/2 h-56 w-fl-2xl bg-gradient-conic from-transparent via-transparent to-primary/60 [--conic-position:from_290deg_at_center_top]"
            >
        ...
        >
          <section className="flex flex-col items-center text-center space-y-4">
            <h1
              className={cn(
                "text-4xl sm:text-4xl md:text-fl-4xl font-bold tracking-tight",
                titleClassName,
              )}
            >
              {title}
            ...
            {subtitle && (
              <p
                className={cn(
                  "md:text-fl-4xl text-muted-foreground",
                  subtitleClassName,
                )}
              >
                {subtitle}
